...
public class PayStrV2Bean {
    ...
    private PingppOrderBean pingpp_order;
    ...
    public PingppOrderBean getPingpp_order() {
        return pingpp_order;
    }

    public void setPingpp_order(PingppOrderBean pingpp_order) {
    ...
    public static class PingppOrderBean {
        /**
