 ...
 */
@Entity
public class TopDynamicBean extends BaseListBean {
    ...
    @Convert(converter = DynamicDetailBeanV2.ImagesBeansVonvert.class, columnType = String.class)
    ...
    @Convert(converter = DynamicDetailBeanV2.PaidNoteConverter.class, columnType = String.class)
    private DynamicDetailBeanV2.PaidNote paid_node;
    ...
    private int top = TOP_SUCCESS;// 置顶状态 0：无置顶状态 1：置顶成功 -1：置顶审核中
    ...
    @Generated(hash = 1038185071)
    private transient TopDynamicBeanDao myDao;

    @Generated(hash = 356758605)
    public TopDynamicBean(Long id, String created_at, String updated_at, String deleted_at, Long user_id, String feed_content,
            ...
            double amount, boolean paid, List<DynamicDetailBeanV2.ImagesBean> images, List<Integer> diggs,
            DynamicDetailBeanV2.PaidNote paid_node, Long hot_creat_time, boolean isFollowed, int state, int top,
    ...
    public DynamicDetailBeanV2.PaidNote getPaid_node() {
        return this.paid_node;
    }

    public void setPaid_node(DynamicDetailBeanV2.PaidNote paid_node) {
        this.paid_node = paid_node;
    }
    ...
    public static class ImagesBean implements Parcelable, Serializable {
        ...
        public static final Creator<DynamicDetailBeanV2.ImagesBean> CREATOR = new Creator<DynamicDetailBeanV2.ImagesBean>() {
            @Override
            public DynamicDetailBeanV2.ImagesBean createFromParcel(Parcel source) {
                return new DynamicDetailBeanV2.ImagesBean(source);
            }

            @Override
            public DynamicDetailBeanV2.ImagesBean[] newArray(int size) {
                return new DynamicDetailBeanV2.ImagesBean[size];
            }
        };
    ...
    public static class PaidNote implements Serializable, Parcelable {
        ...
        public static final Creator<DynamicDetailBeanV2.PaidNote> CREATOR = new Creator<DynamicDetailBeanV2.PaidNote>() {
            @Override
            public DynamicDetailBeanV2.PaidNote createFromParcel(Parcel source) {
                return new DynamicDetailBeanV2.PaidNote(source);
            }

            @Override
            public DynamicDetailBeanV2.PaidNote[] newArray(int size) {
                return new DynamicDetailBeanV2.PaidNote[size];
            }
        };
    }


    public static class ImagesBeansVonvert implements PropertyConverter<List<DynamicDetailBeanV2.ImagesBean>, String> {
        @Override
        public List<DynamicDetailBeanV2.ImagesBean> convertToEntityProperty(String databaseValue) {
        ...
        @Override
        public String convertToDatabaseValue(List<DynamicDetailBeanV2.ImagesBean> entityProperty) {
    ...
    public static class PaidNoteConverter implements PropertyConverter<DynamicDetailBeanV2.PaidNote, String> {

        @Override
        public DynamicDetailBeanV2.PaidNote convertToEntityProperty(String databaseValue) {
            if (databaseValue == null) {
                return null;
            }
            return ConvertUtils.base64Str2Object(databaseValue);
        ...
        @Override
        public String convertToDatabaseValue(DynamicDetailBeanV2.PaidNote entityProperty) {
            if (entityProperty == null) {
                return null;
            }
            return ConvertUtils.object2Base64Str(entityProperty);
    ...
    @Generated(hash = 1696376367)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getTopDynamicBeanDao() : null;
    }
    ...
    protected TopDynamicBean(Parcel in) {
        ...
        this.paid_node = in.readParcelable(DynamicDetailBeanV2.PaidNote.class.getClassLoader());
