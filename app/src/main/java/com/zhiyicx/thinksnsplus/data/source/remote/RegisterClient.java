...
public interface RegisterClient {
    ...
    /**
     * @param phone           Required without email, HintSideBarUserBean China phone bumber.
     * @param email           Required withput phone, HintSideBarUserBean E-Mail.
     * @param name            Required, HintSideBarUserBean registerByPhone name.
