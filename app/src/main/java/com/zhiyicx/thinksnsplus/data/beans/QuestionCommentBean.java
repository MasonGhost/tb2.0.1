 ...
 */
@Entity
public class QuestionCommentBean extends BaseListBean{
    ...
    public void setFromUserInfoBean(UserInfoBean fromUserInfoBean) {
        synchronized (this) {
            ...
            user_id = fromUserInfoBean == null ? null : fromUserInfoBean.getUser_id();
    ...
    public void setToUserInfoBean(UserInfoBean toUserInfoBean) {
        synchronized (this) {
            ...
            reply_user = toUserInfoBean == null ? null : toUserInfoBean.getUser_id();
    ...
    public void setPublishUserInfoBean(UserInfoBean publishUserInfoBean) {
        synchronized (this) {
            ...
            target_user = publishUserInfoBean == null ? null : publishUserInfoBean.getUser_id();
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1038761003)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getQuestionCommentBeanDao() : null;
    }

    public QuestionCommentBean() {
    }

    protected QuestionCommentBean(Parcel in) {
        super(in);
    ...
    @Generated(hash = 1761485398)
    public QuestionCommentBean(Long id, long comment_mark, Long user_id, Long target_user,
            Long reply_user, String body, int commentable_id, String commentable_type,
            String created_at, String updated_at, int state) {
        this.id = id;
        this.comment_mark = comment_mark;
        this.user_id = user_id;
        this.target_user = target_user;
    ...
    public static final Creator<QuestionCommentBean> CREATOR = new Creator<QuestionCommentBean>() {
        @Override
        public QuestionCommentBean createFromParcel(Parcel source) {
            return new QuestionCommentBean(source);
        }

        @Override
        public QuestionCommentBean[] newArray(int size) {
            return new QuestionCommentBean[size];
        }
    };
    ...
    @Generated(hash = 2120433369)
    private transient QuestionCommentBeanDao myDao;
