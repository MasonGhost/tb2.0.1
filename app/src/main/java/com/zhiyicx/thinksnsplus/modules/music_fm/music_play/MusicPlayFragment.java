...
//            rxStartProgress();
    ...
    public void onMusicLoading(int currentDuration) {
        ...
        if (currentDuration > 0) {
            updateDuration(new MediaMetadataCompat.Builder().putLong(MediaMetadataCompat
...
//            case R.id.fragment_music_paly_container:
    ...
    private void initMusicCenterPopWindow(final int position, float amout,
        ...
        mPayMusicPopWindow = PayPopWindow.builder()
                ...
                .buildDescrStr(String.format(getString(strRes), PayConfig.realCurrencyFen2Yuan(amout),mPresenter.getGoldName()))
