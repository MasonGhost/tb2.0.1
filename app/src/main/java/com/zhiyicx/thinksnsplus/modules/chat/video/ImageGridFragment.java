...
import com.zhiyicx.thinksnsplus.modules.chat.video.util.ImageResizer;
import com.zhiyicx.thinksnsplus.modules.chat.video.util.Utils;
import com.zhiyicx.thinksnsplus.widget.chat.RecyclingImageView;
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.item_choose_video, container, false);
