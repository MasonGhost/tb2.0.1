...
public class RecorderVideoActivity extends EaseBaseActivity implements
    ...
    private CenterAlertPopWindow mSendPopupWindow;
    private CenterAlertPopWindow mNoSdCardPopupWindow;
    private CenterAlertPopWindow mFailPopupWindow;
        ...
        switch (view.getId()) {
            ...
            case R.id.recorder_stop:
                ...
                if (mSendPopupWindow == null) {
                    mSendPopupWindow = CenterAlertPopWindow.builder()
                            .with(this)
                            .parentView(btnStart)
                            .isOutsideTouch(true)
                            .isFocus(true)
    ...
    private void showFailDialog() {
        if (mFailPopupWindow == null){
            mFailPopupWindow = CenterAlertPopWindow.builder()
                    .with(this)
                    .parentView(btnStart)
                    .isOutsideTouch(true)
                    .isFocus(true)
                    ...
                    .backgroundAlpha(CustomPopupWindow.POPUPWINDOW_ALPHA)
                    .titleStr(getString(R.string.prompt))
                    .desStr(getString(R.string.Open_the_equipment_failure))
                    .buildCenterPopWindowItem1ClickListener(new CenterAlertPopWindow.CenterPopWindowItemClickListener() {
                        @Override
                        public void onRightClicked() {
                            mFailPopupWindow.hide();
                        }
        ...
        mFailPopupWindow.show();
    }

    private void showNoSDCardDialog() {
        if (mNoSdCardPopupWindow == null){
            mNoSdCardPopupWindow = CenterAlertPopWindow.builder()
                    .with(this)
                    .parentView(btnStart)
                    .isOutsideTouch(true)
                    .isFocus(true)
