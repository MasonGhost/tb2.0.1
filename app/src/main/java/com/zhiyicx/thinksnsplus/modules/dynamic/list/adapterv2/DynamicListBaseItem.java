...
import com.zhiyicx.thinksnsplus.widget.NineImageViewGroup;
...
public class DynamicListBaseItem implements ItemViewDelegate<DynamicDetailBeanV2> {
    ...
    public void convert(ViewHolder holder, DynamicDetailBeanV2 dynamicBean, DynamicDetailBeanV2
        ...
        try {
            ...
            NineImageViewGroup nineImageViewGroup = holder.getView(R.id.nrv_image_nine);
            nineImageViewGroup.setChildCount(dynamicBean.getImages());
