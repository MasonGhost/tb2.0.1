...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if(attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.wheelview_wltextColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.wheelview_wltextColorCenter,textColorCenter);
            dividerColor = a.getColor(R.styleable.wheelview_wldividerColor,dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.wheelview_wltextSize,textSize);
        }
