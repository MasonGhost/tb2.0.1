...
public abstract class PlatformPage extends OnekeySharePage {
    ...
    public void onCreate() {
         ...
         * 需要设置的背景
         */
        llPanel.setBackgroundResource(ShareSDKR.getColorRes(getContext(), "shareback"));

        lp = new LinearLayout.LayoutParams(
                LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);

        llPanel.setAnimation(animShow);
        llPanel.setPadding(100,30,100,0);
...
//        btcancle.setText("取消");
//        lp = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,90);
//        lp.gravity = Gravity.CENTER_HORIZONTAL;
//        btcancle.setLayoutParams(lp);
//        btcancle.setGravity(Gravity.CENTER);
////        btcancle.setBackgroundResource(ShareSDKR.getBitmapRes(getContext(), "selector_white_box"));
