...
public class ApiConfig {
    ...
    public static final String APP_PATH_INFO_DETAILS_FORMAT = "dist/index.html#/news/%s";
...
//    public static final String APP_COMPONENT_FEED = "feed";
    ...
    public static final String APP_PATH_INFO_GET_MY_COMMENT = "api/" + API_VERSION_2 + "/news/my/{news}/comments";// 获取用户对该资讯评论列表
