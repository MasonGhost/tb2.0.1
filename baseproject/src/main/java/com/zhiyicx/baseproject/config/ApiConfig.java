...
//    public static final String APP_DOMAIN = "http://192.168.2.199/";// 本地服务器
...
//    public static final String APP_IM_DOMAIN = "ws://tsplus.zhibocloud.cn:9900";// im 正式服务器
    ...
    public static final String APP_PATH_DYNAMIC_DELETE_COMMENT_V2 = "api/" + API_VERSION_2 + "/feeds/%s/comment/%s";
    // 对一条动态或一条动态评论进行评论
