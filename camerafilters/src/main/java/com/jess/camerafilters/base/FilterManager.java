...
public class FilterManager {
    public static List<String> FILETER_NAME = Arrays.asList("无", "黑白", "自然", "温暖", "老照片", "小清新", "静谧", "秋色");
    ...
    private OnGlSurfaceShotListener mGlSurfaceShotListener;
    ...
    private FilterManager(Builder builder) {
        ...
        mGlSurfaceShotListener = builder.mGlSurfaceListener;
    }
    ...
    public void initialize() {
        ...
        mFullScreen.setOnGlSurfaceShotListener(mGlSurfaceShotListener);
    ...
    public static final class Builder {
        ...
        private Context mContext;
        private onExtFilterListener mExtFilterListener;
        private OnGlSurfaceShotListener mGlSurfaceListener;
        ...
        public Builder addGlSurfaceShotListener(OnGlSurfaceShotListener listener) {
