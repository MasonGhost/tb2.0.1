...
package com.zhiyicx.zhibolibrary.ui.components.refresh;
 ...
 * 创建时间:15/5/21 12:56
 * 描述:继承该抽象类实现响应的抽象方法，做出各种下拉刷新效果。参考BGANormalRefreshViewHolder、StickinessRefreshViewHolder、MoocStyleRefreshViewHolder、MeiTuanRefreshViewHolder
 */
public abstract class RefreshViewHolder {
    ...
    public View getLoadMoreFooterView() {
        ...
        if (mLoadMoreFooterView == null) {
            mLoadMoreFooterView = View.inflate(mContext, R.layout.zb_view_normal_refresh_footer, null);
