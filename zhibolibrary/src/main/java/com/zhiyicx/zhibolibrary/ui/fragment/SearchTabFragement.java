 ...
 */
public class SearchTabFragement extends ZBLBaseFragment implements SearchTabView, RefreshLayout.BGARefreshLayoutDelegate {
    ...
    public static SearchTabFragement newInstance(String type) {
        Bundle args = new Bundle();
        SearchTabFragement fragment = new SearchTabFragement();
    ...
    protected View initView() {
        ...
        mPlaceHolder= (ImageView) mRootView.findViewById(R.id.iv_search_tab_placeholder);
