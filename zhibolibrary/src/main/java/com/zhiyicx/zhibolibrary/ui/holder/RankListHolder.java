...
/// 这一步必须要做,否则不会显示.
        ...
        mStarTV.setText("" + data.user.fans_count);
        mGoldTV.setText("" + data.user.gold);
        ...
        if (this.getPosition() < 3) {
            mRankTV.setTextColor(UiUtils.getColor("color_font_red"));
        }
        else {
            mRankTV.setTextColor(UiUtils.getColor("color_font_black_light"));
        }
    }
