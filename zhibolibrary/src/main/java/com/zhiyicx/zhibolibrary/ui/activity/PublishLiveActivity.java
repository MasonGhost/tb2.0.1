 ...
 */
public class PublishLiveActivity extends ZBLBaseActivity implements PublishView, PublishCoreParentView, View.OnClickListener {
...
//        UiUtils.statuInScreen(this);//全屏，并且沉侵式状态栏
        ...
        mSelectBT.setOnClickListener(PublishLiveActivity.this);
        ...
        mCloseBT.setOnClickListener(PublishLiveActivity.this);
    }
...
//        });
    ...
    public void launchAlbum() {
        Crop.pickImage(PublishLiveActivity.this);
    }

    @Override
    public void clearCameraFragmentImg() {
        if (mCameraView != null) mCameraView.clearImage();
    }

    @Override
    public void setPlaceHolderVisible(final boolean isVisiable) {
        //                            UiUtils.glideWrap(BaseApplication.getUserInfo().avatar.origin).transform(new GaussianBlurTrasform(PublishLiveActivity.this)).into(ivHolder);
...
//                            UiUtils.glideWrap(BaseApplication.getUserInfo().avatar.origin).transform(new GaussianBlurTrasform(PublishLiveActivity.this)).into(ivHolder);
    ...
    public void launchCamera() {
        ...
        PublishLiveActivity.this.startActivityForResult(intent, RESULT_CAPTURE_IMAGE);
    }
...
//        showLoadding(false);
    ...
    public UserInfo getUserInfo() {
        return ZhiboApplication.userInfo;
    }
