...
import com.zhiyicx.zhibolibrary.ui.components.sweetsheet.widget.CRImageView;
...
public class RecyclerViewDelegate extends Delegate  {
    ...
    protected View createView() {
        ...
        View rootView = LayoutInflater.from(mParentVG.getContext())
                .inflate(R.layout.zb_layout_rv_sweet, null, false);
        ...
        mMenuRVAdapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (mOnMenuItemClickListener != null) {
                    if (mOnMenuItemClickListener.onItemClick(parent,view,position, menuEntities.get(position))) {
                        delayedDismiss();
                    }
                }
            }
