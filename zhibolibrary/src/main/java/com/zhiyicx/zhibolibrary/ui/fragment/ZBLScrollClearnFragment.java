...
public class ZBLScrollClearnFragment extends ZBLBaseFragment {
    ...
    public static ZBLScrollClearnFragment newInstance(int param1) {
        ZBLScrollClearnFragment fragment = new ZBLScrollClearnFragment();
    ...
    private void initViewPager() {
        ...
        vpContainer.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrollStateChanged(int state) {
                ((ZBLPublishCoreFragment)mFragmentList.get(1)).hidekeyboard();
            }
        });
    ...
    public List<ZBLBaseFragment> getFragments() {
        ...
        fragmentList.add(new ZBLEmptyFragment());
