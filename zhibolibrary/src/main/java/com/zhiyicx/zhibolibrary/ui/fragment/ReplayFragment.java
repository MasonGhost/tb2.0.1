 ...
 */
public class ReplayFragment extends LiveFragment {
    ...
    protected List<ZBLBaseFragment> getFragements() {
        ...
        fragmentList.add(new ReplayOwnFragment());
        fragmentList.add(new ReplayFollowFragment());
        fragmentList.add(new ReplayAllFragment());
        return fragmentList;
    }
