 ...
 */
public abstract class ZBLLiveFragment extends ZBLBaseFragment implements LiveView, ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private void initViewPager() {
        ...
        for (ZBLBaseFragment f : mFragmentList) {
            mLiveFragmentList.add((ZBLLiveItemFragment) f);
        }
