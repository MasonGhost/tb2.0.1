package com.zhiyicx.zhibolibrary.ui.components.sweetsheet.viewhandler;
...
import com.zhiyicx.zhibolibrary.ui.components.sweetsheet.adapter.MenuRVAdapter;
...
public class MenuListViewHandler {
    ...
    public View onCreateView(ViewGroup container) {
        if(mView == null){
            mView = LayoutInflater.from(container.getContext()).inflate(R.layout.zb_layout_grid_menu,container,false);
            onViewCreated(mView);
        }
        return mView;
    }
        ...
        mMenuRVAdapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                if (mOnFragmentInteractionListener != null) {
                    mOnFragmentInteractionListener.onFragmentInteraction(parent,v,mIndex * mNumColumns*2 + position);
                }
            }
        });
    ...
    public void refreshList(){
        mMenuRVAdapter.notifyNoAimation();
    }

    public interface OnFragmentInteractionListener {

        void onFragmentInteraction(AdapterView<?> parent, View view, int index);
    }
