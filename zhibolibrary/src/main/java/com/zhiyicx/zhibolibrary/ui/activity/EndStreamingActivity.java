 ...
 */
public class EndStreamingActivity extends ZBLBaseActivity implements EndStreamView, View.OnClickListener {
    ...
    protected void initView() {
        ...
        mTopButton.setOnClickListener(EndStreamingActivity.this);
        ibEndStreamWeixin = (ImageButton) findViewById(R.id.ib_end_stream_weixin);
        ibEndStreamWeixin.setOnClickListener(EndStreamingActivity.this);
        ibEndStreamFriend = (ImageButton) findViewById(R.id.ib_end_stream_friend);
        ibEndStreamFriend.setOnClickListener(EndStreamingActivity.this);
        ibEndStreamQq = (ImageButton) findViewById(R.id.ib_end_stream_qq);
        ibEndStreamQq.setOnClickListener(EndStreamingActivity.this);
        ibEndStreamSina = (ImageButton) findViewById(R.id.ib_end_stream_sina);
        ibEndStreamSina.setOnClickListener(EndStreamingActivity.this);
        ibEndStreamZone = (ImageButton) findViewById(R.id.ib_end_stream_zone);
        ibEndStreamZone.setOnClickListener(EndStreamingActivity.this);
        btEndStreamGoHome = (Button) findViewById(R.id.bt_end_stream_go_home);
        btEndStreamGoHome.setOnClickListener(EndStreamingActivity.this);
...
//                    System.out.println("VERTICAL -----translateX= " + translateX);
    ...
    public void isAudience(boolean isAudience) {
        ...
        if (isAudience) {//观众结束界面
            mPlayTV.setTextColor(UiUtils.getColor("color_blue_gray"));
