 ...
 */
public abstract class LiveItemFragment extends ZBLBaseFragment implements LiveItemView, RefreshLayout.BGARefreshLayoutDelegate {
    ...
    protected View initView() {
        ...
        mPlaceHolder = (ImageView) mRootView.findViewById(R.id.iv_live_item_placeholder);
        return mRootView;
    }
...
//                mPresenter.getList(false);//请求列表,最新数据,只能调用一次
    ...
    public void showNotFollowPH() {
        ...
        mPlaceHolder.setImageResource(R.mipmap.focus_pic_default);
    }

    @Override
    public void shwoNothingPH() {
        mPlaceHolder.setVisibility(View.VISIBLE);
        mPlaceHolder.setImageResource(R.mipmap.videolist_pic_default);
    }

    @Override
    public void showFilterNothingPH() {
        mPlaceHolder.setVisibility(View.VISIBLE);
        mPlaceHolder.setImageResource(R.mipmap.screening_pic_default);
    }
