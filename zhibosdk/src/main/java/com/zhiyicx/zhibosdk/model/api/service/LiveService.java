...
public interface LiveService {
    ...
    @FormUrlEncoded
    @POST(ZBApi.BASE_API)
    Observable<ZBApiStream> createStream(@Field("api") String api,
                                         @Field("ak") String ak);
    ...
    @FormUrlEncoded
    @POST(ZBApi.BASE_API)
    Observable<ZBCheckStreamPullJson> checkStream(@Field("api") String api,
                                                  @Field("ak") String ak,
    ...
    @FormUrlEncoded
    @POST(ZBApi.BASE_API)
    Observable<ZBApiJson> startStream(@Field("api") String api,
                                      @Field("ak") String ak,
    ...
    @FormUrlEncoded
    @POST(ZBApi.BASE_API)
    Observable<ZBEndStreamJson> endStream(@Field("api") String api,
                                          @Field("ak") String ak,
                                          @Field("stream_id") String id);
    ...
    @FormUrlEncoded
    @POST(ZBApi.BASE_API)
    Observable<ZBApiPlay> getPlayUrl(@Field("api") String api, @Field("ak") String ak,
    ...
    @Multipart
    @POST(ZBApi.BASE_API)
    Observable<ZBBaseJson<ZBIconInfo[]>> upload(@Part("api") String api, @Part("ak") String ak,
    ...
    @FormUrlEncoded
    @POST(ZBApi.BASE_API)
    Observable<ZBApiJson> imDisable(@Field("api") String api,
                                    @Field("ak") String ak,
    ...
    @FormUrlEncoded
    @POST(ZBApi.BASE_API)
    Observable<ZBApiJson> imEnable(@Field("api") String api, @Field("ak") String ak,
                                   @Field("usid") String usid,
                                   @Field("cid") int cid
    );
